...
namespace YouTubeDownloader.Utils
{
    internal static class Json
    {
        public static string Extract(string source)
        {
            ...
            // We trust that the source contains json, we just need to extract it.
            // To do so, we will match curly braces until we even out.
        ...
        public static HttpContent SerializeToHttpContent<T>(T obj)
            => new StringContent(
