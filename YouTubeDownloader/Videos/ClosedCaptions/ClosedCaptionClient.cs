            ...
            CancellationToken cancellationToken = default)
        {
            ...
            var trackInfos = playerResponse
                ...
                .Select(t =>
                {
                    var url =
                        t.TryGetUrl() ??
                        throw new YoutubeDownloaderException("Could not extract track URL.");

                    var languageCode =
                        t.TryGetLanguageCode() ??
                        throw new YoutubeDownloaderException("Could not extract track language code.");

                    var languageName =
                        t.TryGetLanguageName() ??
                        throw new YoutubeDownloaderException("Could not extract track language name.");
                ...
                .Select(c =>
                {
                    ...
                    var parts = c
                        ...
                        .Select(p =>
                        {
                            ...
                            var partOffset =
                                p.TryGetOffset() ??
                                throw new YoutubeDownloaderException("Could not extract caption part offset.");
