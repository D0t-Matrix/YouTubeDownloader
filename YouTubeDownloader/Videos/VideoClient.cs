...
using YouTubeDownloader.Videos.ClosedCaptions;
using YouTubeDownloader.Videos.Streams;

namespace YouTubeDownloader.Videos
{
    /// <summary>
    ...
    public class VideoClient
    {
            ...
            CancellationToken cancellationToken = default)
        {
            ...
            var uploadDate =
                ...
                throw new YoutubeDownloaderException("Could not extract video upload date.");
